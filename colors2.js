...
function nightDayHandler(self) { //nightDayHandler 함수에 this 라는 값이 대입됨.
  ...
  if (self.value === 'colors2 jquery night mode on') {
    ...
    self.value = 'colors2 jquery day mode on'; //< !--if 값이 참 일경우, 현재 소속된 태그의 밸류값을 'day mode on' 으로 치환한다-- >
    ...
    self.value = 'colors2 jquery night mode on'; // nightDayHandler 라는 함수의 파라미터값인 self 에다가 인수 this 를 넣는다.
